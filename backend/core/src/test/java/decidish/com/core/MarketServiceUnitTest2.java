...
class MarketServiceUnitTest2 {
        ...
        void testGetAllProducts_MergesAndSaves() {
                ...
                // when(apiClient.searchProducts(any(URI.class), eq(marketReweId), any(),
                // any()))
                // .thenReturn(apiResponse);
        ...
        void testGetProductsQuery_MergesAndSaves() {
                ...
                assertEquals(2, marketCaptor.getValue().getProducts().size(),
                                "Should update existing and add new products");
