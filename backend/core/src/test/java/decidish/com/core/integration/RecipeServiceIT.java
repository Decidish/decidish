...
class RecipeServiceIT {
        ...
        void testFuzzyMatchingPreProcessing_Integration() {
                // Set up some ingredients in the DB (about 3-5 should suffice for integration
                // test)
                ...
                // Set up some products in the DB (some of them should match the ingredients,
                // others not)
                ...
                // assertFalse(generatedMappings.isEmpty(), "Generated mappings should not be
                // empty");
