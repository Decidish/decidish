...
import { ImageBackground, Image, View, ScrollView, Dimensions, Platform, TouchableOpacity } from 'react-native';
import { Stack, useRouter } from 'expo-router';
import { Text } from '@/components/ui/text';
import { Button } from '@/components/ui/button';
import { Icon } from '@/components/ui/icon';
import { ArrowRight, Clock, Trash2, Utensils, CheckCircle, User, Heart, Instagram, Linkedin, Twitter} from 'lucide-react-native';
      ...
      <ScrollView className="flex-1 bg-white" showsVerticalScrollIndicator={false}>
        ...
        <View style={{ height: SCREEN_HEIGHT, minHeight: 600 }}>
            ...
            <View className="flex-1 bg-black/40 items-center justify-center px-6">
                <View className="w-full max-w-4xl items-center">
                    <Text numberOfLines={1} adjustsFontSizeToFit className="text-white text-6xl md:text-8xl font-extrabold mb-4 p-2 italic text-center">
                        Decidish
                    </Text>
                    ...
                    <Text className="hidden md:flex text-white/90 text-center text-lg md:text-xl leading-relaxed max-w-2xl mb-12">
        ...
        <View className="py-12 md:py-20 px-6 bg-white items-center">
          ...
          <View className="w-full max-w-6xl md:grid md:grid-cols-2 gap-8 md:gap-12 ">
              ...
              <View className="hidden md:flex h-full w-full rounded-2xl shadow-lg overflow-hidden items-center">
                  <Image
        ...
        <View className="py-12 md:py-24 px-6 bg-teal-500 items-center">
            <View className="max-w-5xl items-center">
                ...
                <Text className="max-w-sm md:max-w-max text-lg md:text-xl text-center text-white/90 mb-8 leading-relaxed">
...
const SocialIcon = ({ icon: IconType }: any) => (
    <TouchableOpacity className="w-10 h-10 bg-gray-800 rounded-full items-center justify-center hover:bg-teal-500 transition-colors">
